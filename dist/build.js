...
function createSpecialPluginConfigByFeatureMap(featureMap, specialTransformConfig) {
    const result = {};
    const _transformConfig = Object.assign(Object.assign({}, _transformConfig__WEBPACK_IMPORTED_MODULE_1__["default"]), specialTransformConfig);
...
function getWebpackConfig(specialWebpackConfig) {
    ...
    return Object.assign(Object.assign({}, defaultConfig), specialWebpackConfig);
}
